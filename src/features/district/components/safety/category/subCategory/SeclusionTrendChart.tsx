...
const SeclusionTrendChart: React.FC<SeclusionTrendChartProps> = ({ className }) => {
  ...
  const chartData = useMemo<ChartDataPoint[]>(() => {
    if (!districtSeclusionData || !stateSeclusionData || !districtEnrollmentData || !stateEnrollmentData) return [];
    
    // Sort the data by year in ascending order
    const sortedDistrictData = [...districtSeclusionData].sort((a, b) => a.year - b.year);
  ...
  }, [districtSeclusionData, stateSeclusionData, districtEnrollmentData, stateEnrollmentData]);
